...
def reset():
    global curr_bit_p, byte_array, msg_running, checksum, rx_checksum, decoded, cs_c_cpl, pass_key, cs_inb_heard, start_rx
    curr_bit_p = 0
    byte_array = [None, None, None, None, None, None, None, None]
    msg_running = False
    checksum = 0
        ...
        while True:
            ...
            if magnitude > 0.01:
                ...
                if(read_data(freq)[0] == "s" and start_rx == False): #start
                    ...
                    print("Current data RX: " + decoded) #theoretical debug
                    ...
                    if (pass_key == True):
                        rx_checksum = int(decoded, 2)  # decode binary string directly to int, not via UTF-8
